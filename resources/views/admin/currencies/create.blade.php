<x-layouts.app title="Add Currency - Admin">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Add New Currency</h1>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" 
                           ...
                           value="{{ old('exchange_rate_to_usd', '1.00') }}" 
                           step="0.000001" 
                           min="0.000001" 
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white" 
                           placeholder="1.00">
                ...
                <div>
                    ...
                    <select id="decimal_places" 
                        ...
                        <option value="1" {{ old('decimal_places') == '1' ? 'selected' : '' }}>1 decimal place</option>
                        <option value="2" {{ old('decimal_places', '2') == '2' ? 'selected' : '' }}>2 decimal places</option>
                        <option value="3" {{ old('decimal_places') == '3' ? 'selected' : '' }}>3 decimal places</option>
                        <option value="4" {{ old('decimal_places') == '4' ? 'selected' : '' }}>4 decimal places</option>
                        <option value="5" {{ old('decimal_places') == '5' ? 'selected' : '' }}>5 decimal places</option>
                        <option value="6" {{ old('decimal_places') == '6' ? 'selected' : '' }}>6 decimal places</option>
                    </select>
