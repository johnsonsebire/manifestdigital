<x-layouts.app :title="__('Forms Management')">
                        ...
                        <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-700/50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-2 rtl:space-x-reverse">
                                    ...
                                    <!-- Delete Modal -->
                                    <x-modal name="delete-form-{{ $form->id }}" :title="'Delete Form: ' . $form->title">
                                        <div class="p-6">
                                            <p class="mb-6">Are you sure you want to delete this form? This will also delete all submissions associated with this form.</p>
                                    ...
                                    <button type="button" onclick="copyToClipboard('[form id={{ $form->id }}]')"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            console.log('Forms index page initialized');
        });
    </script>
</x-layouts.app>